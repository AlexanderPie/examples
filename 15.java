...
public class Main {
    ...
    public static void playGame() {
        ...
        // заполним 2-мерный массив элементами перемешанной коллекции list
        for (byte i = 0; i < 4; i++) {
            for (byte j = 0; j < 4; j++) {
    ...
    // метод проверяет выполненность условия выигрыша
    ...
    // метод проверяет, соседствует ли введенное число с пустой клеткой (0)
